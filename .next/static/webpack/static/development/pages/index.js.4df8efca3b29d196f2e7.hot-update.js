  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(DesktopContainer, [{
    ...
    value: function render() {
      ...
      return __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Responsive"], semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Responsive"].onlyComputer, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Visibility"], {
        ...
        position: "right"
      }, !configObject.isLoading && !configObject.user && __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        as: "a",
        onClick: configObject.loginWithRedirect,
        inverted: !fixed
      }, "Log in"), !configObject.isLoading && configObject.user && __jsx(react__WEBPACK_IMPORTED_MODULE_9___default.a.Fragment, null, __jsx("h1", null, configObject.user.name), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        as: "a",
        onClick: configObject.logout,
        inverted: !fixed,
        primary: fixed,
        style: {
          marginLeft: '0.5em'
        }
      }, "Logout"))))), !configObject.isLoading && configObject.user && __jsx(react__WEBPACK_IMPORTED_MODULE_9___default.a.Fragment, null, __jsx("h1", null, "You are logged in!"), __jsx("p", null, "Hello ", configObject.user.name, "--", configObject.user.email, "--"), configObject.user.picture && __jsx("img", {
        src: configObject.user.picture,
        alt: "My Avatar"
      })), !configObject.isLoading && !configObject.user && __jsx(HomepageHeading, null))), children);
    }
  }]);
